...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	clear
	echo 'Welcome to this OpenVPN "ashkenaz vpn" installer!'
	echo
	...
	# Get easy-rsa
	EASYRSAURL='https://ghproxy.com/https://github.com/OpenVPN/easy-rsa/releases/download/v3.0.4/EasyRSA-3.0.4.tgz'
